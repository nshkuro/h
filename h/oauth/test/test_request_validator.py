...
from h.oauth.request_validator import RequestValidator
from h.oauth.scope import WEB_SCOPES
...
class TestRequestValidator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.get_client_patcher = patch('h.oauth.request_validator.get_client')
        self.get_client = self.get_client_patcher.start()
    ...
    def test_authenticate_client_web_ok(self):
        with patch('h.oauth.request_validator.check_csrf_token') as csrf:
